...
If you have a table of geometry data and want to represent it as a FeatureCollection, you can construct the appropriate GeoJSON using the built in JSON functions of PostgreSQL:
